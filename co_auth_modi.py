...
#for reading the aminer papers
for i in range(1,2):
    filename ="/home/ari/Documents/Ambiguity-Project/Dataset/mag_papers/mag_papers_"+str(i)+'.txt'
    with open(filename,'r') as f:
        start_time = tm.time()
        print("Reading file "+ filename)
        for line in f:
...
with open("Author_Map.csv",'w') as csvfile:
